...
class ForgotPasswordParents extends StatefulWidget {
  const ForgotPasswordParents({super.key});

  @override
  State<ForgotPasswordParents> createState() => _ForgotPasswordParentsState();
}

class _ForgotPasswordParentsState extends State<ForgotPasswordParents> {
  final _formKey = GlobalKey<FormState>();
  final TextEditingController _emailController = TextEditingController();

  void _forgotPasswordParent(String email) async {
    final url = Uri.parse(
        'https://vaccine-integration-main-xxocnw.laravel.cloud/api/forgot-password');
    try {
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const RegisterParents()),
                    );
                  },
                  child: const Text(
                    " Register",
